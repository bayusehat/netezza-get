...
# Run SQL Netezza
sql_str = """SELECT nper, nd, is_paid FROM telkombda..CHURN_SYMPTOM_GROUP_BILLPER WHERE nper = '202212' AND is_paid = 1 AND to_char(PAYMENT_DATE, 'YYYYMM') = '{}' """.format(curmonth)
curs = conn.cursor()
